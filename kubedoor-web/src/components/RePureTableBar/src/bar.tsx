    ...
    const reference = {
      reference: () => (
        <SettingIcon
          ...
          v-tippy={rendTippyProps(transformI18n("buttons.pureColumnSettings"))}
        />
      )
    };
          ...
          <div class="flex justify-between w-full h-[60px] p-4">
            ...
            <div class="flex items-center justify-around">
              ...
              <RefreshIcon
                ...
                v-tippy={rendTippyProps(transformI18n("buttons.pureRefresh"))}
                onClick={() => onReFresh()}
              />
              <el-divider direction="vertical" />
              {/* <el-dropdown
              ...
              >
                <div class={[topClass.value]}>
                  <el-checkbox
                    class="!-mr-1"
                    label={transformI18n("buttons.pureColumnSettings")}
                    v-model={checkAll.value}
                    indeterminate={isIndeterminate.value}
                    onChange={value => handleCheckAllChange(value)}
                  />
                  <el-button type="primary" link onClick={() => onReset()}>
                    {{ default: () => transformI18n("buttons.pureReset") }}
                  </el-button>
                </div>
              ...
              <iconifyIconOffline
                ...
                v-tippy={
                  isFullscreen.value
                    ? transformI18n("buttons.pureExitFullScreen")
                    : transformI18n("buttons.pureFullScreen")
                }
